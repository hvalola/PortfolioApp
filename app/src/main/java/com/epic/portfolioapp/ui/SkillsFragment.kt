...
import com.epic.portfolioapp.framework.AboutViewModel
...
class SkillsFragment : Fragment() {
    ...
    lateinit var skillTextView : TextView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        skillTextView = view.findViewById(R.id.skillTextView)
    ...
    private fun observeViewModel() {
        viewModel.currentProfile.observe(this, Observer { profile->
            profile?.let{
                skillTextView.text = profile.skill
